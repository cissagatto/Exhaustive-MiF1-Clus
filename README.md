...
## How to cite 
@misc{Gatto2022, author = {Gatto, E. C.}, title = {Exhaustive Micro-F1 Partitions for Multilabel Classification with Clus}, year = {2022}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/Exhaustive-MiF1-Clus}}}
...
## RUN
To run the code, open the terminal, enter the */Exhaustive-MiF1-Clus/R/* folder, and type
...
```
Rscript exhaustive.R "~/Exhaustive-MiF1-Clus/EMiC-Config-Files/EMiC-GpositiveGO.csv"
```
