...
###############################################################################
FolderJob = paste(FolderRoot, "/EMiC-Jobs", sep = "")
...
while (i <= n) {
  ...
  # job name
  job_name = paste("EMiC-", dataset$Name, sep = "")

  # directory name
  folder_name = paste("/scratch/", job_name, sep = "")

  # Confi File Name
  file_name = paste("EMiC-", dataset$Name, ".csv", sep="")
  ...
  write("echo =================================================",
        file = output.file, append = TRUE)
  write("echo SBATCH: RUNNING EXHAUSTIVE MICRO F1 CLUS PARTITIONS",
        file = output.file, append = TRUE)
  write("echo =================================================",
        file = output.file, append = TRUE)
  ...
  str7 = paste("Rscript /home/u704616/Exhaustive-MiF1-Clus/R/exhaustive.R \"/home/u704616/EMiC-Config-Files/",
               file_name, "\"", sep = "")
