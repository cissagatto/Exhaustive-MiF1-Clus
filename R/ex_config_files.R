...
###############################################################################
FolderCF = paste(FolderRoot, "/EMiC-Config-Files", sep="")
...
while(i<=n){
  ...
  # Confi File Name
  file_name = paste(FolderCF, "/EMiC-", ds$Name, ".csv", sep="")
  ...
  write("Dataset_Path, ~/Exhaustive-MiF1-Clus/Datasets",
        file = output.file, append = TRUE)
  ...
  write("Partitions_Path, ~/Exhaustive-MiF1-Clus/Partitions/BellPartitions",
        file = output.file, append = TRUE)
